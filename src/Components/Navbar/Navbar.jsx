  ...
  return (
    <div className='navbar'>
        ...
        <ul className='nav-menu'>
            ...
            <li><p onClick={()=>setMenu("services")}>Sevices</p>{menu==="services"?<img src={underline} alt=''/>:<></>}</li>
            <li><p onClick={()=>setMenu("project")}>Portfolio</p>{menu==="project"?<img src={underline} alt=''/>:<></>}</li>
